...
public class MyFirstTelegramBot extends TelegramLongPollingBot {
    ...
    public String getBotUsername() {
        return "alexmscw_mscw_bot";
    }

    @Override
    public String getBotToken() {
        return "8141919473:AAHmX4BQY6OyMsYG4OGxQRKNkmgxHTVdDQ8";
    }
        ...
        if (update.hasCallbackQuery()) {
            if (update.getCallbackQuery().getData().equals("step_1_btn") && getGlories(chatId) == 0) {
                sendMessage(chatId, 20, "step_2_pic", STEP_2_TEXT,
                        Map.of(
                                "Взяти сосиску! +20 слав", "step_2_btn",
                                "Взяти рибку! +20 слав", "step_2_btn",
                                "Скинути банку з огірками! +20 слав", "step_2_btn"));
            }
